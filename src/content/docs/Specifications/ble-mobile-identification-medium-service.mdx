...
description: BLE GATT Service Specification for the mobile identification medium
template: doc
sidebard:
  order: 2
---
...
| ------ | ------ | ------ | ------ | ------ |
| MobileGroups | 9DB2CA58-D890-46D5-A142-59F3C1164B10 | *read* | List of  Identifiers valid for the given [Component](/domain/access-components/component-overview/). Contains 16 entries of 32 byte UUID's  | Attribute size 512 bytes |
